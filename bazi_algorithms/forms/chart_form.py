...
class ChartFormManual(FlaskForm):
    ...
    stem_choices = [("Jia", 'Jia'), ("Yi", 'Yi'), ("Bing", 'Bing'), ("Ding", 'Ding'), ("Wu", 'Wu'), ("Ji", 'Ji'),
                    ("Geng", 'Geng'), ("Xin", 'Xin'), ('Ren', 'Ren'), ("Gui", 'Gui')]
    branch_choices = [("Zi", 'Zi'), ("Chou", 'Chou'), ("Yin", 'Yin'), ("Mao", 'Mao'), ("Chen", 'Chen'), ("Si", 'Si'),
...
class ChartFormBirthTime(FlaskForm):
    ...
    hour_choices = [("12am-1am", '12am-1am'), ("1am-3am", '1am-3am'), ("3am-5am", '3am-5am'), ("5am-7am", '5am-7am'),
                    ("7am-9am", '7am-9am'), ("9am-11am", '9am-11am'), ("11am-1pm", '11am-1pm'), ("1pm-3pm", '1pm-3pm'),
                    ('3pm-5pm', '3pm-5pm'), ("5pm-7pm", '5pm-7pm'), ("7pm-9pm", '7pm-9pm'), ("9pm-11pm", '9pm-11pm'),
                    ("11pm-12am", '11pm-12am')]
