...
from .punish import (count_earth_bully_punish,
                     count_earth_uncivil_punish,
                     count_earth_self_punish,
                     count_earth_ungrateful_punish,
                     )
...
def calc_comb_clash(natal_stem, natal_earth, dates):
    ...
    for i in range(len(dates)):
        ...
        row = {"s_combine": s_combine, "s_clash": s_clash, "e_combine": e_combo_combine + e_harmony_combine,
               "e_clash": e_clash + e_bp + e_ugp + e_sp + e_ucp + e_dest + e_harm}
        result.append(row)
    return result
