def explanation_list_paid():
    return [
        [
            ...
            ("Criteria",
             "Based on a combine in the person's Month or Year Branch, with the target's Month or Year Branch."),
            ...
            "),
            ("Interpretation (Natal Year Pillar)",
             "In standard readings, a natal year branch represents public persona, connections and social networking skills."),
            ...
            ("Interesting Titbits",
             "Everyone will have a month branch combine with dynamic luck branch in their 4th luck cycle, which generally represents our peak career years."),
            ("Combine with External Month Pillar",
             "Relative to the entire year cycle (12 months), we can expect this person to have their career peak during these months."),
            ("Combine with External Year Pillar",
             "Relative to an entire branch cycle (12 years), we can expect this person to have career peaks anytime this year. During the External Month Combine within this year, then even more likely."),
...
def explanation_list_free():
    return [
        [
            ...
            ("Combine with External Month Pillar",
             "This is a paid feature, unlock this with any paid plan (Plus, Premium, Annual)."),
            ("Combine with External Year Pillar",
             "This is a paid feature, unlock this with any paid plan (Plus, Premium, Annual)."),
            ("Caveats", "Note that combines are not always positive, it just represents potential ability. Read more about Combines vs Clashes here.\
            <br><br>\
