...
def explanation_list():
    return [
        [
            ...
            ("Criteria", "Based on a combine in the person's Month or Year Branch, with the external Month or Year Branch."),
        ...
        ("Criteria", "Based on a person's Day Pillar branch, each has 1 branch element regarded as peach blossom.\
        <br><br>\
        Peach blossom is the energy of attractiveness, sometimes with a romantic connotation."),
        ...
        ("Criteria", "Based on a person's DayMaster, each has 1 branch element regarded as peach blossom.\
        <br><br>\
        Peach blossom is the energy of attractiveness, sometimes with a romantic connotation.\
        <br><br>\
